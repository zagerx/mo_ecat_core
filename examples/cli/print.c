...
{
	switch (state) {
	case MO_ECAT_NODE_AL_STATE_INIT:       return "INIT";
	case MO_ECAT_NODE_AL_STATE_PRE_OP:     return "PRE-OP";
	case MO_ECAT_NODE_AL_STATE_SAFE_OP:    return "SAFE-OP";
	case MO_ECAT_NODE_AL_STATE_OP:         return "OP";
	case MO_ECAT_NODE_AL_STATE_BOOTSTRAP:  return "BOOT";
	default:                          return "UNKNOWN";
	}
}
